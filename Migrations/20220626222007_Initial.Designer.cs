...
namespace BlogWebApi.Migrations
{
    ...
    [Migration("20220626222007_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogWebApi.Models.Post", b =>
                {
                    b.HasOne("BlogWebApi.Models.User", "Author")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("BlogWebApi.Models.Tag", null)
                        .WithMany()
                    ...
                    b.HasOne("BlogWebApi.Models.Post", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("UserRole", b =>
                {
                    b.HasOne("BlogWebApi.Models.Role", null)
                        .WithMany()
                    ...
                    b.HasOne("BlogWebApi.Models.User", null)
                        .WithMany()
